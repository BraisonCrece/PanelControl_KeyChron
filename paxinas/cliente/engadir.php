...
<head>
    <meta charset="UTF-8">
    <title>Keychron | Engadir Cliente</title>
        ...
        <div class="card text-center">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="true" href="#" id="pestana_engadir">Introducir Cliente</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./eliminar.php" id="pestana_eliminar">Eliminar Cliente</a>
                    </li>
                </ul>
            </div>
            <div class="card-body shadow">
                <!-- INTRODUCIR CLIENTE -->
                <form action="engadir.php" method="post" class="text-start" id="form_engadir">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="apelidos" id="apelidos" class="form-control" maxlength="100">
                    </div>
                    <div class="mb-3">
                        <label for="email" class="form-label">Email</label>
                        <input type="email" name="email" id="email" class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" maxlength="100">
                    </div>
...
if (isset($_POST["nome"]) && isset($_POST["apelidos"]) && isset($_POST["email"])) {
    engadir_cliente($conexion, $_POST);
}
?>
